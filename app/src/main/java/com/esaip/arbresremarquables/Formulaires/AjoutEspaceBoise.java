...
public class AjoutEspaceBoise extends AppCompatActivity {
    ...
    private String stringTextNomPrenom;
    private String stringTextPseudo;
    private String stringTextObservations;
    private String stringTextMail;
    private String stringTextAdresse;
    private String stringLatitude;
    private String stringLongitude;
    private String stringAutreBiodiversite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonValider = findViewById(R.id.buttonValiderEsp);
        ...
        autreCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
        ...
        buttonValider.setOnClickListener(v -> {
            ...
            //boolean checkBiodiversite = (checkBoxEcureuil.isChecked() || checkBoxChauve.isChecked() || checkBoxCapricorne.isChecked() || checkBoxPic.isChecked() || checkBoxChouette.isChecked() || autreCheckBox.isChecked());
            ...
            if ((count == 9 && !autreCheckBox.isChecked()) || (count == 10 && autreCheckBox.isChecked())) {
                ...
                //Zip le CSV + Photo
                zipPath = paths + "reponse_appli_EB_" + stringPhoto.replace("JPEG_", "").replace(".jpg", "") + ".zip";
    ...
    private void openDialog() {
        ...
        String stringEspace = spinnerTypeEspace.getSelectedItem().toString();
        String stringNombresArbres = spinnerNbArbres.getSelectedItem().toString();
        String stringNombresEspeces = spinnerNbEspeces.getSelectedItem().toString();
        String stringNiveau = getNiveau();
        String stringBiodiv = getBiodiv();
        String stringGlobal = getGlobal();
        String stringEau = spinnerEau.getSelectedItem().toString();
        String stringAbris = spinnerAbris.getSelectedItem().toString();
        String stringEclairage = spinnerEclairage.getSelectedItem().toString();
        String stringOmbre = spinnerOmbre.getSelectedItem().toString();
        String stringEntretien = spinnerEntretien.getSelectedItem().toString();
        stringTextObservations = editTextObservations.getText().toString();

        DialogEspaceBoise dialog = new DialogEspaceBoise(stringTextNomPrenom, stringTextPseudo, stringTextMail, stringTextAdresse, stringEspace, stringNombresArbres, stringNombresEspeces, stringNiveau, stringEau, stringAbris, stringEclairage, stringBiodiv, stringOmbre, stringEntretien, stringGlobal, stringTextObservations, zipPath);
